...
class BucketlistTest(TestBaseCase):
    ...
    def test_list_bucketlists(self):
        ...
        self.assertEqual(len(BucketlistItem.list_bucketlists()), 4)
    ...
    def test_get_bucketlist(self):
        ...
        self.assertEqual(BucketlistItem.get_bucketlist(2)["name"], "new")
        self.assertEqual(BucketlistItem.get_bucketlist(3)["name"], "blood")
        self.assertEqual(BucketlistItem.get_bucketlist(4)["name"], "hounds")
    ...
    def test_delete_bucketlist(self):
        ...
        BucketlistItem.delete_bucketlist(2)
    ...
    def test_create_item(self):
        ...
        # create one item
        BucketlistItem.create_item({"name": "item1"}, 2)
    ...
    def test_udpate_item(self):
        ...
        # update the item
        BucketlistItem.update_item({"done": "true"}, 2, 2)
    ...
    def test_delete_item(self):
        ...
        self.assertEqual(Item.query.count(), 2)
        # delete that item
        BucketlistItem.delete_item(2, 2)
